...
import { migratePhase1Data } from '../src/migrations.js';
...
test('Phase 1データをOCR封筒付きschema v2へmigrationする', () => { const state = migratePhase1Data({ records: [{ paidDate: '2026-01-01' }], evidences: [{ id:'e', evidenceNumber:'E-001', fileName:'a.jpg' }], children:[{id:'child-1',name:'子1'}] }); assert.equal(state.schemaVersion,2); assert.equal(state.evidences[0].ocr.status,'not_started'); });
