...
for (const file of ['index.html', 'styles.css', 'phase2.js', 'mobile-ui.js', 'reason-suggestions.js', 'receipt-items.js', 'evidence-export.js', 'data-backup-ui.js', 'submission-numbering-ui.js', 'favicon.ico', 'favicon-16x16.png', 'favicon-32x32.png', 'apple-touch-icon.png', 'icon-192x192.png', 'icon-512x512.png']) await copy(file);
await copy('src');
